...
// ConditionStatusValue provides a mock function with given fields: conditionID
func (_m *MockConditionStatusQueryor) ConditionStatusValue(conditionID string) (*condition.StatusValue, error) {
	ret := _m.Called(conditionID)

	if len(ret) == 0 {
		panic("no return value specified for ConditionStatusValue")
	}

	var r0 *condition.StatusValue
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*condition.StatusValue, error)); ok {
		return rf(conditionID)
	}
	if rf, ok := ret.Get(0).(func(string) *condition.StatusValue); ok {
		r0 = rf(conditionID)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*condition.StatusValue)
		}
	}
...
// MockConditionStatusQueryor_ConditionStatusValue_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ConditionStatusValue'
type MockConditionStatusQueryor_ConditionStatusValue_Call struct {
	*mock.Call
}

// ConditionStatusValue is a helper method to define mock.On call
//   - conditionID string
func (_e *MockConditionStatusQueryor_Expecter) ConditionStatusValue(conditionID interface{}) *MockConditionStatusQueryor_ConditionStatusValue_Call {
	return &MockConditionStatusQueryor_ConditionStatusValue_Call{Call: _e.mock.On("ConditionStatusValue", conditionID)}
}

func (_c *MockConditionStatusQueryor_ConditionStatusValue_Call) Run(run func(conditionID string)) *MockConditionStatusQueryor_ConditionStatusValue_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockConditionStatusQueryor_ConditionStatusValue_Call) Return(_a0 *condition.StatusValue, _a1 error) *MockConditionStatusQueryor_ConditionStatusValue_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockConditionStatusQueryor_ConditionStatusValue_Call) RunAndReturn(run func(string) (*condition.StatusValue, error)) *MockConditionStatusQueryor_ConditionStatusValue_Call {
	_c.Call.Return(run)
	return _c
}
