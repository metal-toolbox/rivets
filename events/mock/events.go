...
//
//	mockgen -source=events/events.go -package=mock_events
//
...
import (
	...
	events "github.com/metal-toolbox/rivets/events"
...
func (mr *MockStreamMockRecorder) Publish(ctx, subject, msg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) PullMsg(ctx, batch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockStreamMockRecorder) Subscribe(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
// ExtractOtelTraceContext mocks base method.
func (m *MockMessage) ExtractOtelTraceContext(ctx context.Context) context.Context {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExtractOtelTraceContext", ctx)
	ret0, _ := ret[0].(context.Context)
	return ret0
}

// ExtractOtelTraceContext indicates an expected call of ExtractOtelTraceContext.
func (mr *MockMessageMockRecorder) ExtractOtelTraceContext(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExtractOtelTraceContext", reflect.TypeOf((*MockMessage)(nil).ExtractOtelTraceContext), ctx)
}
